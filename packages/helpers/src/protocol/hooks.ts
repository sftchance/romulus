// Generated by @wagmi/cli@1.0.0 on 5/10/2023 at 12:00:55 AM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export function writeLock<TFunctionName extends string>(
  ...
  return writeContract({
    abi: lockABI,
    ...config,
  } as unknown as WriteContractArgs<typeof lockABI, TFunctionName>)
}
...
>(
  ...
  return watchContractEvent(
    { abi: lockABI, ...config } as WatchContractEventConfig<TAbi, TEventName>,
    callback,
  )
}
